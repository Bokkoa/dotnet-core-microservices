...
namespace Shopservices.RabbitMQ.Bus.Implement
{
    public class RabbitEventBus : IRabbitEventBus
    {
        ...
        public void Publish<T>(T newEvent) where T : Event
        {
            ...
            using( var channel = connection.CreateModel()){
                ...
                var message = JsonConvert.SerializeObject(newEvent);
            ...
            where TH : IEventHandler<T>
        {
            ...
            if(_handlers[eventName].Any(x => x.GetType() == handlerEventType)){
                throw new ArgumentException($"The handler {handlerEventType.Name} has been registered before by {eventName}");
            }
